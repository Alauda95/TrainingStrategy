...
seeds = [8442,9345,5372,7146,1004,7891,8704,294,4369,1518]
datapath = os.getcwd()
f = open(datapath + "\\seeds" + ".txt", "w")
for seed in seeds:
    f.write(str(seed) + ',')
f.close()
ensemble = 1
...
lr, num_epochs, batch_size = 0.00050, 200, 24
...
for index_iter in range(ITER):
    ...
    train.train(net, train_iter, valida_iter, loss, optimizer, device, epochs=num_epochs,early_stopping=True,best_model = False,
          early_num=30)
