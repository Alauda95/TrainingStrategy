...
def train(net, train_iter, valida_iter, loss, optimizer, device, epochs=30, early_stopping=True,best_model = False,
          early_num=20):
    loss_list = [100]
    early_epoch = 0
